package laboratory7.service;

import java.util.Collection;
import java.util.List;
import java.util.Scanner;

import laboratory7.hashsets.bean.Employee;

import laboratory7.hashsets.pl.EmployeeServiceImpl;
import laboratory7.hashsets.pl.IEmployeeService;
